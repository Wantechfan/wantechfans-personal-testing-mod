...
Events.on(ClientLoadEvent, e => { 
    ...
    unit.weapons.get(0).bullet.fragBullet.weapons.get(0).bullet.collidesAir = true;
    unit.weapons.get(0).bullet.fragBullet.weapons.get(0).bullet.buildingDamageMultiplier = 1;
});
